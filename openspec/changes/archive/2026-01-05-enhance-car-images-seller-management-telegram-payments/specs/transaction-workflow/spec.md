# transaction-workflow Spec Delta

## Purpose
This spec delta extends the transaction workflow capability to integrate real-time Telegram notifications for payment events, enabling immediate awareness of sales activity and faster order fulfillment. This improves operational efficiency and customer service response times.
...
None - all existing requirements remain valid and are enhanced by the notification functionality.
